node {
    ...
    def dockerhubaccountid = "sermed78"
    ...
    stage('Clone Repo') { 
      ...
      git url:'https://github.com/sermed78/Project3.git',branch:'main' //update your forked repo
      // Get the Maven tool.
   ...
   stage('Remove running container with old code'){
    ...
    stage('Deploy Docker Image with new changes'){
	  ...
	  sh "docker run -d -p 2222:2222 ${dockerhubaccountid}/${application}:${env.BUILD_NUMBER}"  
